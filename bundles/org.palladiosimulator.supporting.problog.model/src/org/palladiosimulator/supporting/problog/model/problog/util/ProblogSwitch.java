...
public class ProblogSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ProblogPackage.PROBABILISTIC_FACT: {
				ProbabilisticFact probabilisticFact = (ProbabilisticFact)theEObject;
				T result = caseProbabilisticFact(probabilisticFact);
				if (result == null) result = caseClause(probabilisticFact);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProblogPackage.PROBABILISTIC_RULE: {
				ProbabilisticRule probabilisticRule = (ProbabilisticRule)theEObject;
				T result = caseProbabilisticRule(probabilisticRule);
				if (result == null) result = caseClause(probabilisticRule);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Probabilistic Fact</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Probabilistic Fact</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseProbabilisticFact(ProbabilisticFact object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Probabilistic Rule</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Probabilistic Rule</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseProbabilisticRule(ProbabilisticRule object) {
		return null;
	}
